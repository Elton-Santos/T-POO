...
namespace TrabalhoPOO.Persistence
{
    public class InquilinoDAO
    {
        ...
        public void select()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM Inquilino", con);
        ...
        public void delete(MetodosDeComando p)
        {
            ...
            SqlCommand cmd = new SqlCommand("DELETE FROM Inquilino WHERE id_Inquilino='" + p.deletar() + "';", con);
        ...
        public void alterar(int id, string nome)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Inquilino SET nome = '" + nome + "'WHERE id_Inquilino=" + id + ";", con);
                cmd.ExecuteNonQuery();
                con.Close();
